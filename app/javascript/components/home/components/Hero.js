...
export default class Hero extends Component{
  render() {
    return(
      <Box alignSelf="center" direction="column" justify="center" alignContent="center" margin="small" pad="small" flex>
        ...
        <Box alignSelf="center" direction="column" alignContents="center" margin="small" pad="small" flex>
          <Box
          fill
          alignSelf = "center"
          direction="row"
