...
export default class Hero extends Component{
  render() {
    return(
      <Box alignSelf="center" direction="column" alignContent="stretch" margin="small" pad="small" overflow="auto">
        <Box direction="column" justify="center" alignContent="center" pad="small">
          <Globe size="xlarge" />
        ...
        <Box alignSelf="center" direction="row" alignContents="center" margin="small" pad="small">
